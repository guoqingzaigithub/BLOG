   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/BLOG/index.php/Admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/BLOG/index.php/Admin/article/lst">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
        </div>
                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="auther" name="auther" size="50" value="<?php echo ($articles["auther"]); ?>" type="text">
                                </td>
                             </tr>   
                                 <tr>
                                <th>文章描述：</th>
                                <td>
                                    <textarea style="width:450px; height:100px;" name="summary" ><?php echo ($articles["summary"]); ?></textarea>
                                </td>
                            </tr>
                                <tr>
                                <th>缩略图：</th>
                                <td>
                                    ...
                                    <?php if($articles['pic'] != '' ): ?><img src="/BLOG<?php echo ($articles["pic"]); ?>" height="60">
                                    <?php else: ?>
                                    暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
                                ...
                                <td>
                                  <select name="cateid" >
                                      <option value="" >请选择分类</option>
                                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $articles['cateid'] ): ?>selected="selected"<?php else: endif; ?> value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                  </select>
                                </td>
                            </tr>
