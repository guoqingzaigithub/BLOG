   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/BLOG/index.php/Admin/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/BLOG/index.php/Admin/cate/lst">栏目管理</a><span class="crumb-step">&gt;</span><span>新增栏目</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="cateneme" name="catename" size="50" value="" type="text">
                                </td>
                            </tr>
