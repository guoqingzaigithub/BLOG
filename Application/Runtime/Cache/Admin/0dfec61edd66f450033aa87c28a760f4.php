            ...
            <form action="" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <input type="verify" name="verify" value="" id="verify" size="15" class="admin_input_style" /><img style="cursor:pointer;" width="200" height="60" onclick="this.src='/BLOG/index.php/Admin/Login/verify/'+Math.random()" src="/BLOG/index.php/Admin/Login/verify">
                    </li>
                    <li>
