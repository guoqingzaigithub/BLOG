...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/BLOG/index.php/Admin/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">用户管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/BLOG/index.php/Admin/User/sort" >
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td width="5%">
                                <a class="link-update" href="/BLOG/index.php/Admin/User/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <?php if($vo['id'] != 1): ?><a class="link-del" onclick="return confirm('你要删除该用户吗？');" href="/BLOG/index.php/Admin/User/del/id/<?php echo ($vo["id"]); ?>">删除</a><?php endif; ?>
                            </td>
