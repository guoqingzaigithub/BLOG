...
<header class="am-topbar">
  ...
  <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
    ...
    <li <?php if($current == $vo['id']): ?>class='am-active'<?php endif; ?>><a href="/BLOG/index.php/Home/write">写文章</a></li>
    </ul>
  ...
  <div class="am-u-md-9 am-u-md-push-3">
    <div class="am-g">
      <div class="am-u-sm-11 am-u-sm-centered">
        ...
        <p><img class="aligncenter size-full wp-image-51393" src="/BLOG<?php echo ($arts["pic"]); ?>"  width="630" height="340"  sizes="(max-width: 630px) 100vw, 630px" /></p>
